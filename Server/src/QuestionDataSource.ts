...
/**
 * This class initializes the database for the questions by creating the
 * file if it does not exist and fills it with standard questions
 *
...
export class QuestionDataSource {
    ...
    // A new instance of the QuestionDataSource
    private static instance: QuestionDataSource = new QuestionDataSource();

    // This constructor checks if a database called 'Questions.db' already exists and
    ...
    // Returns the instance of the QuestionDataSource
    public static getInstance(): QuestionDataSource {
        return QuestionDataSource.instance;
    }
    // Returns the database
    public getQuestionDatabase(): Database {
        return this.db;
    }
    // Initializes a new database called 'Questions.db' and fills it with standard questions
    public initDataBase() {
        var file = 'Questions.db';
